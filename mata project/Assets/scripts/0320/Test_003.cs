...
public class Test_003 : MonoBehaviour
{
    ...
    void Start()
    {
        string str1 = "happy";          //string형 str1 선언 후 happy 값 입력
        string str2 = "birthday";       //string형 str2 선언 후 birthday 값 입력
        string message;                 //string형 message 선언

        message = str1 + str2;          //message에 str1,str2 문자열들 더함
        Debug.Log(message);             //console.log 창에 message 출력

        str1 += str2;                   //str = str1 + str2 의 축약
        Debug.Log(str1);                //console.log 창에 str2 출력

        int num = 123;                  //int형 num 선언 후 123 값 입력
        message = str1 + num;           //message에
        Debug.Log(message);             //
    }
